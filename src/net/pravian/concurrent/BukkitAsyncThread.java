package net.pravian.concurrent;

import org.bukkit.Bukkit;
import org.bukkit.plugin.Plugin;

/**
 * Represents an asynchronous thread.
 */
public abstract class BukkitAsyncThread implements Runnable {
    ...
    /**
     * Creates a new BukkitAsyncThread with the specified plugin.
     *
     * @param plugin The plugin to create the thread with
     */
    public BukkitAsyncThread(Plugin plugin) {
        this.plugin = plugin;
    }
