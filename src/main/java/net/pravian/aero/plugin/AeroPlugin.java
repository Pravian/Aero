...
public abstract class AeroPlugin<T extends AeroPlugin<T>> extends JavaPlugin
    implements PluginContainer<T>, Listener {
   ...
   *
   * <p>Assuming using <b>config.yml</b> and copying defaults.
   *
