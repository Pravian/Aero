...
public class Reflection {
   ...
   * @param constructorIndex - The constructor's index in the array of constructors. E.g. 0 for the
   *     first constructor.
  ...
  public static MethodInvoker getMethod(
      Class clazz, String methodName, boolean superClasses, Class... parameterTypes) {
