...
public class BukkitSign {
     ...
     *
     * <p>
     * Note: If a sign does not exist at the specified location, this instance will be invalid. Validity can be checked using isSign().</p>
     *
     ...
     *
     * <p>
     * Note: If a sign does not exist at the specified block, this instance will be invalid. Validity can be checked using isSign().</p>
     *
     ...
     *
     * <p>
     * Note: If the BlockState does not belong to a sign, this instance will be invalid. Validity can be checked using isSign()</p>
     *
     ...
     *
     * <p>
     * Note: If create is true, a sign will be created at the specified location if there isn't one already. If no sign is present and create is false, this instance will be invalid.
