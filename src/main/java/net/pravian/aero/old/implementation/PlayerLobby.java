package net.pravian.aero.old.implementation;
...
public class PlayerLobby extends ArrayList<Player> implements List<Player> {
     ...
     *
     * <p>
     * This is a shorthand for PlayerLobby(false)</p>
     *
     ...
     *
     * <p>
     * Passing true as the argument will result in a dynamic lobby. A dynamic lobby has all the features a regular player lobby has with exception that the players in the lobby are always
     ...
     *
     * <p>
     * If the list does not contain the element, it is unchanged. More formally, removes the element with the lowest index i such that (o==null ? get(i)==null : o.equals(get(i))) (if such
     ...
     *
     * <p>
     * <b>Note</b>This validation is case-insensitive.</p>
     *
     ...
     *
     * <p>
     * The message format is a single string representing how messages from {@link #message(java.lang.String) message(String)} should be formatted. When message() gets called, all
     ...
     *
     * <p>
     * <b>Note</b>: See getMessageFormat() for more information.</p>
     *
     * @param messageFormat
     ...
     *
     * <p>
     * <b>Note</b>: If a custom message format has been set, that will be used to display the message.</p>
     *
