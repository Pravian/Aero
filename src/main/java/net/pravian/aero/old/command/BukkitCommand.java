...
public abstract class BukkitCommand<T extends Plugin> {
     ...
     *
     * <p>
     * <b>Warning</b>: Might be null if the console is sending the command.</p>
     */
    protected Player playerSender;
    /**
     * Represents the PLuginLogger used.
     */
    protected AeroLogger logger;
    //
     ...
     *
     * <p>
     * <b>In normal conditions, you should never create BukkitCommand instances</b></p>
     */
     ...
     *
     * <p>
     * Every instance should call this before executing any other method.</p>
     *
     ...
     *
     * <p>
     * Validates if the player has the "permission" value from the CommandPermission annotation. If a custom BukkitPermissionHandler has been registered, it will use that instead.
