package net.pravian.aero.old.command;
...
public class BukkitCommandHandler<T extends Plugin> {
    ...
    public BukkitCommandHandler(T plugin) {
        this(plugin, new AeroLogger(plugin));
    }
     ...
     */
    public BukkitCommandHandler(T plugin, AeroLogger logger) {
        this.plugin = plugin;
        this.logger = logger;
     ...
     *
     * <p>
     * The super permission indicates an override for players. Any sender who has this permission will be able to run all commands executed by this CommandHandler provided the source type
     * is correct.</p>
     *
     ...
     *
     * <p>
     * When command caching is enabled, commands will only be instantiated once. After instantiation, the command will be cached and the
     ...
     *
     * <p>
     * <b>Note</b></p>: Commands will only be instantiated when their first execution is called.
     *
     * <p>
     * <b>Note</b></p>: The cache may be cleared by using {@link #clearCommandCache()}
     */
