...
import net.pravian.aero.internal.InternalMetrics;
...
public final class BukkitLib {
     ...
     *
     * <p>
     * <b>All plugins depending on BukkitLib should call this method at plugin load time.</b></p>
     *
     * @param plugin
     */
     ...
     *
     * <p>
     * All runtime-exceptions will be handled by the exception handler.</p>
     *
     * <p>
     * Set to null to reset to the default handler. The default handler prints the output on the screen.</p>
     *
