 ...
 *
 * <p>
 * Bukkit, by default comes with no functionality to serialize commonly used objects (Location, Inventory, etc) to Strings and back. The classes in this package are easy to use and fit to
