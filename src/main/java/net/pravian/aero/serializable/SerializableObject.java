 ...
 * <p>
 * <p>
 * Bukkit, by default comes with no functionality to serialize commonly used objects (Location,
 * Inventory, etc) to Strings and back. The classes in this package are easy to use and fit to the
 * needs of those who need to store those objects in configuration files.</p>
 * <p>
 * <p>
 * {@link net.pravian.aero.config.YamlConfig#setSerializable(String, SerializableObject)} has easy
 * methods to save and load SerializableObjects.</p>
 *
