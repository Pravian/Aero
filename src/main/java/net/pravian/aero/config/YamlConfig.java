...
public class YamlConfig extends YamlConfiguration implements ConfigurationContainer<YamlConfig> {
     ...
     * default inside the jar-file of the owning plugin.</p>
     *
    ...
    public void load() {
        try {
            ...
            plugin
                .handleException("Could not load configuration file: " + configFile.getName(), ex);
        }
    }
    ...
    public void save() {
        try {
            ...
            plugin
                .handleException("Could not save configuration file: " + configFile.getName(), ex);
        }
    }
    ...
    public YamlConfiguration getDefaultConfig() {
        ...
        try {
            ...
            plugin.handleException("Could not load default configuration: " + configFile.getName(),
                ex);
            return null;
        }
     ...
     * <p>
     * <p>
     * <b>Warning</b>: SerializableObjects should never be stored using {@link #set(String,
     * Object)}
     *
