...
public class Commands {
   ...
   * <p>
   * <p>
   * After a command has been unregistered, it will no longer be able to be executed.</p>
   *
   ...
   * <p>
   * <p>
   * Command-messages are formated as such: <i>/commandName arg1 arg2</i>. These are found in events
   * such as {@link org.bukkit.event.player.PlayerCommandPreprocessEvent}.
   * </p>
   *
  ...
  private static <T> T getField(Object from, String name) {
    ...
    while (checkClass.getSuperclass() != Object.class && ((checkClass = checkClass.getSuperclass())
        != null));
  }
}
