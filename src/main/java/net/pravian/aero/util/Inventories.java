...
public class Inventories {
  ...
  /**
   * Obtains an item of the given type and data in the inventory specified<br> If multiple items
   * with the same type and data exist, their amounts are added together
   * <p>
   * <p>
   * Author: bergerkiller</p>
   *
