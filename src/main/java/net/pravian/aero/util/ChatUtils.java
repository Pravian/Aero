...
public class ChatUtils {
   ...
   *
   * <p><b>Warning</b>: This does not include special ChatColors ChatColor.RESET, ChatColor.BOLD,
   * ChatColor.UNDERLINE, ChatColor.STRIKETHROUGH, ChatColor.ITALIC and ChatColor.WHITE
   *
   * @see ChatColor
   */
   ...
   */
  public static void messagePlayers(
      String message, String permission, Collection<? extends Player> players) {
