...
public abstract class SimplePermissionHandler implements AeroPermissionHandler {
  ...
  private final Map<Class<? extends AeroCommandBase<?>>, Set<String>> permissions =
      Maps.newHashMap();
   ...
   * <p>
   *
   * <p><b>Note</b>: The set contains a list of permissions of which <b>one</b> must be owned by the
   * sender in order to process the command.
   *
  ...
  public boolean containsPermission(
      Class<? extends AeroCommandBase<?>> command, String permission) {
