...
public abstract class SmartCommand<T extends AeroPlugin<T>> extends TooledCommandBase<T>
   ...
   *
   * <p>Uses {@link Players#getOfflinePlayer(String)}.
   *
   * @return The OfflinePlayer that has been found (<b>Or null if the toPlayer could not be
   *     found!</b>)
