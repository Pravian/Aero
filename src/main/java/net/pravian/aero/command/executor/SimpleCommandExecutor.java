...
public class SimpleCommandExecutor<C extends AeroCommandBase<?>>
    extends AbstractCommandExecutor<C> {
  ...
  public boolean hasPermission(CommandSender sender, boolean sendMsg) {
    ...
    if (options != null) {
      final String permission =
          options.permission().isEmpty()
              ? handler.getPlugin().getName().toLowerCase() + "." + options.subPermission()
              : options.permission();
