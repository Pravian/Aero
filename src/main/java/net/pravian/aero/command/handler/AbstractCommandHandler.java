...
public abstract class AbstractCommandHandler<T extends AeroPlugin<T>> extends PluginComponent<T>
    implements AeroCommandHandler<T> {

  @Getter @Setter protected String superPermission = plugin.getName().toLowerCase() + ".*";
  ...
  @Getter @Setter protected String commandClassPrefix = "Command";
  @Getter @Setter private AeroPermissionHandler permissionHandler = null;
